        ...
        <div>
            <Container>
                <Handler>
                    ...
                    <div style={{ width: '220px', marginLeft: '16px', height: '0', border: '1px solid #C778DD' }} />
                </Handler>
                <Content>
                    <Figures>
                        <Dots style={{
                    ...
                    <SkillSets>
                        ...
                        <div>
                            <SkillBox type='Tools' skills='VSCode Neovim Linux FFmpeg Git Some Other Cool Shit' />

                            <SkillBox type='Frameworks' skills='TensorFlow PyTorch Node.js FastAPI Django' />
                        </div>
                    </SkillSets>
                </Content>
            </Container>
